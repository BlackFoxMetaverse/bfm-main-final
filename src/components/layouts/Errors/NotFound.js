...
function BackButton({ children }) {
  ...
  return (
    <button onClick={() => router.back()} className="justify-center px-8 py-3.5 mt-12 text-lg leading-5 text-white capitalize whitespace-nowrap bg-indigo-500 rounded font-[450] max-md:px-5 max-md:mt-10">
      {children}
    </button>
  );
}
